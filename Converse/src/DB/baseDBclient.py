"""БД клиента: декларативное создание таблиц, одноименных классов и их отображения."""
...
class Contact(Base):
    """Клиент-пользователь мессенджера"""
...
class Message(Base):
    ...
    def __eq__(self, other):
        # сообщение одинаковые, когда все поля кроме ключа одинаковые
        return self.Text == other.Text and self.CreatedDatetime == other.CreatedDatetime \
                                       and self.ContactId == other.ContactId
